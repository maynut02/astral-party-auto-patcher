          ...
          "files": [
            {
              "name": "base.apk",
              "splitName": null,
              "downloadUrl": "https://github.com/maynut02/astral-party-auto-patcher/releases/download/android-game-v1234/base.apk",
              "sha256": "${"b".repeat(64)}",
              "size": 100
            },
            {
              ...
              "downloadUrl": "https://github.com/maynut02/astral-party-auto-patcher/releases/download/android-game-v1234/split-001-config.arm64_v8a.apk",
              "sha256": "${"c".repeat(64)}",
              "size": 200
            }
          ]
